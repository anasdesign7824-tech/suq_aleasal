select
  ...
  to_regclass('public.requests')::text as requests_table,
  to_regclass('private.client_mutations')::text as client_mutations_table
...
where (n.nspname = 'public' and c.relname in ('users', 'stores', 'products', 'messages', 'requests'))
   or (n.nspname = 'private' and c.relname = 'client_mutations')
