...
export const adminApi = {
  ...
  manualActivateSubscription: (input: { merchantId: string; planId: string; note?: string | null }) => request<{ item: unknown }>('/api/admin/subscriptions/activate', { method: 'POST', body: JSON.stringify(input) }),
