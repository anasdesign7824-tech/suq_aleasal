...
export const adminApi = {
  ...
  updateLaunchCampaign: (input: { discountPercent: number; isActive: boolean; startsAt?: string | null; endsAt?: string | null; appliesTo?: string[] }) => request<{ item: unknown }>('/api/admin/subscription-campaigns/app-launch', { method: 'PATCH', body: JSON.stringify(input) }),
