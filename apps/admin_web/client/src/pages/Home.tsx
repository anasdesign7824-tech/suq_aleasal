...
import { AdminDesignPreviewPanel } from "@/components/AdminDesignPreviewPanel";

type ViewKey = "overview" | "products" | "stores" | "requests" | "merchant-applications" | "store-verification" | "plans" | "banners" | "taxonomy" | "logistics" | "admins" | "audit" | "users" | "notifications" | "analytics" | "design-preview";
...
const navItems: Array<{ key: ViewKey; label: string; icon: typeof LayoutDashboard }> = [
  ...
  { key: "design-preview", label: "بيانات التصميم التجريبية", icon: Paintbrush },
];
...
export default function Home({ session, onLogout }: { session: AdminSessionPayload; onLogout: () => Promise<void> }) {
  ...
  const titles: Record<ViewKey, { eyebrow: string; title: string; subtitle: string }> = {
    ...
    "store-verification": { eyebrow: "خدمة Pro", title: "توثيق المتاجر", subtitle: "مراجعة مستقلة للرسوم والمستندات والشارة، ولا تعني فتح المتجر تلقائيًا." },
    plans: { eyebrow: "الاشتراكات والدفع", title: "الخطط وحملة الافتتاح", subtitle: "الأسعار والخصم والحوالة المحلية وتفعيل المزايا من Production." },
    ...
    "design-preview": { eyebrow: "معاينة تجريبية", title: "بيانات التصميم التجريبية", subtitle: "تلمس الشكل والترتيب والبيانات دون الكتابة في Supabase." },
  };
