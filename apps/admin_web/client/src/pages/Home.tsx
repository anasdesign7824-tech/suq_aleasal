...
const navItems: Array<{ key: ViewKey; label: string; icon: typeof LayoutDashboard }> = [
  ...
  { key: "store-verification", label: "توثيق المتاجر Pro", icon: ShieldCheck },
  { key: "plans", label: "الخطط والحملة والدفع", icon: WalletCards },
  { key: "banners", label: "البنرات", icon: ImagePlus },
  { key: "taxonomy", label: "التصنيفات", icon: Layers3 },
  { key: "logistics", label: "التوصيل والاستلام", icon: Truck },
