...
المصدر الأصلي هو `references/data/yemeni_honey_master_database_final.json`. تم توليد 30 منتجًا و3 متاجر وطلبات وإشعارات تجريبية حتمية. تبقى المراجعات والتقييمات وأعدادها فارغة عمدًا؛ لا يسمح المشروع باختلاق محتوى ينشئه العملاء، بما فيه التقييمات أو الشهادات. الأصول المرئية المشار إليها ضمن Demo موجودة في `assets/brand/` ولا تُستخدم كبديل عن البيانات.
