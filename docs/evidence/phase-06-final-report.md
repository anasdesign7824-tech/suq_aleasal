...
تتضمن Home لاكتشاف العسل اليمني، البحث، المنتجات المختارة، تفاصيل المنتج، حالة عدم وجود مراجعات موثقة، وطلب تواصل تجريبي. تعتمد هذه الشاشات على `AssalRepository` ولا تنفذ استدعاءات Supabase مباشرة.
