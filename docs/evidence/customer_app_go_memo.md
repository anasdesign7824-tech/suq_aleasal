...
يمكن بدء حزمة **Supabase / Backend / RLS Forensic Audit** لأن حزمة العميل أصبحت تملك عقودًا واضحة ونقاط حقن Production ومصفوفة اختبارات قابلة لإعادة التشغيل. لا يجوز نشر APK/Web للجمهور أو تسميتهما production-ready قبل إغلاق الشروط أعلاه، ولا يجوز بدء Admin/Landing على أساس أن بوابة الإطلاق العام قد اجتازت.
